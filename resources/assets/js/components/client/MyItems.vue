                        ...
                        <div class="card-deck padding-5px">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><small>By <a class="action-link">{{item.seller}}</a></small></p>
                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            getItems(options = {offset: 0}) {
                axios.get('/client/get-my-items/search?' + this.urlEncodeOptions(options))
                    .then(response => {
                    ...
                    .then((dialog) => {
                        setTimeout(() => {
                            axios.post('/client/delete-item/' + item.id )
                                ...
                                if (typeof error.response.data === 'object') {
                                    this.deleted = error.response.data;
                                } else {
                                    this.deleted = error.response.data;
                                }
                            });
